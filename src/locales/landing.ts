...
export const landing: Namespace = {
  en: {
    ...
    "hero.subtitle":
      "A calm, premium space where you always know exactly what happens next — and when it's our turn, you can simply relax.",
    "hero.cta": "Enter my portal",
    "features.sign.title": "Sign in minutes",
    "features.sign.body":
      "Your agreement lives in the portal. One signature, and the journey starts.",
  ...
  fr: {
    ...
    "hero.subtitle":
      "Un espace calme et premium où vous savez toujours exactement ce qui se passe ensuite — et quand c'est à nous d'agir, vous pouvez simplement vous détendre.",
    "hero.cta": "Accéder à mon portail",
    "features.sign.title": "Signez en quelques minutes",
    "features.sign.body":
      "Votre contrat vit dans le portail. Une signature, et le voyage commence.",
    ...
    "features.follow.body":
      "Onze étapes de l'accord au lancement, avec une prochaine action toujours claire.",
  ...
  de: {
    ...
    "hero.subtitle":
      "Ein ruhiger, hochwertiger Raum, in dem Sie immer genau wissen, was als Nächstes passiert — und wenn wir am Zug sind, können Sie einfach entspannen.",
    "hero.cta": "Zu meinem Portal",
    "features.sign.title": "In Minuten unterschreiben",
    "features.sign.body":
      "Ihre Vereinbarung lebt im Portal. Eine Unterschrift, und die Reise beginnt.",
    ...
    "features.follow.body":
      "Elf Schritte von der Vereinbarung bis zum Start, mit einer klaren nächsten Aktion.",
  ...
  es: {
    ...
    "hero.subtitle":
      "Un espacio tranquilo y premium donde siempre sabes exactamente qué pasa después — y cuando nos toca a nosotros, tú simplemente puedes relajarte.",
    ...
    "features.follow.body":
      "Once pasos desde el acuerdo hasta el lanzamiento, con una próxima acción siempre clara.",
  ...
  ru: {
    ...
    "hero.subtitle":
      "Спокойное премиальное пространство, где вы всегда точно знаете, что будет дальше — а когда очередь за нами, вы можете просто расслабиться.",
    "hero.cta": "Войти в мой портал",
    "features.sign.title": "Подпишите за минуты",
    "features.sign.body":
      "Ваш договор хранится в портале. Одна подпись — и путешествие начинается.",
    ...
    "features.follow.body":
      "Одиннадцать этапов от договора до запуска, с одним понятным следующим действием.",
    "features.grow.title": "Развивайтесь после запуска",
    "features.grow.body":
      "Планы обслуживания и дополнения, когда бы они ни понадобились вашему продукту.",
  },
};
