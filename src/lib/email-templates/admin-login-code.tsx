...
export interface AdminLoginCodeEmailProps {
  code?: string;
}

export function AdminLoginCodeEmail({ code = "" }: AdminLoginCodeEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>Votre code d&apos;accès administrateur</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Text style={styles.brand}>WAYNE-WEB</Text>
          <Heading style={styles.heading}>Accès administrateur</Heading>
          <Text style={styles.text}>Voici votre code d&apos;accès :</Text>
...
export const template = {
  component: AdminLoginCodeEmail,
  displayName: "Admin login code",
