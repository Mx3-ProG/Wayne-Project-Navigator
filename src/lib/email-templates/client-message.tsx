...
const styles = {
  body: { backgroundColor: '#0b0c10', margin: 0, padding: '32px 0', fontFamily: 'Helvetica, Arial, sans-serif' },
  container: {
  ...
  text: { color: '#d5d7de', fontSize: '15px', lineHeight: '24px', margin: '0 0 14px', whiteSpace: 'pre-line' as const },
  linkBox: { backgroundColor: '#1b1e26', borderRadius: '12px', padding: '16px', margin: '8px 0 16px' },
