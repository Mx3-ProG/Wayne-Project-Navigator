...
export function ResetPasswordCodeEmail({ code = "" }: ResetPasswordCodeEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>Votre code de réinitialisation de mot de passe</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Text style={styles.brand}>WAYNE-WEB</Text>
          <Heading style={styles.heading}>Réinitialisation de mot de passe</Heading>
          <Text style={styles.text}>Voici votre code de réinitialisation :</Text>
...
export const template = {
  component: ResetPasswordCodeEmail,
