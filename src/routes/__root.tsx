  ...
  head: () => ({
    meta: [
      ...
      { title: "Wayne Client Portal" },
      {
        name: "description",
        content:
          "The premium client space for Wayne-Web projects: agreement, payment, brief, progress and delivery.",
      },
      { name: "author", content: "Wayne-Web" },
      { property: "og:title", content: "Wayne Client Portal" },
      {
